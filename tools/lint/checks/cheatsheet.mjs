...
// capabilities/capability-lifecycle/harnesses/<harness-runtime>.md (the top-level
// harnesses/ alternative is kept for fixtures); a README.md is not one.
export function checkCheatsheets({ files, report, root }) {
  for (const rel of files) {
    if (!/^(?:capabilities\/[^/]+\/)?harnesses\/(?!README\.md$)[^/]+\.md$/.test(rel)) continue;
