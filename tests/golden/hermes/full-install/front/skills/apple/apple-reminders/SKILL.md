...
remindctl add --title "Meeting prep" --due "<DATE> 09:00"
```
...
```bash
remindctl add --title "Hairdresser" --due "<DATE> 14:00" --alarm "<DATE> 13:30"
```

To edit an existing reminder:

```bash
remindctl edit 87354 --due "<DATE> 14:00" --alarm "<DATE> 13:30"
```
