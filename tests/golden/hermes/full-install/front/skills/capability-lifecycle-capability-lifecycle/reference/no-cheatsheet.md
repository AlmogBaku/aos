...
2. **[A]** Draft `<clone>/capabilities/capability-lifecycle/harnesses/<harness-runtime>.md`
   ...
   is the reference shape). Keep it lean: your harness's half only.
...
4. Proceed with the operation using your draft, telling the user the mappings are
   ...
   upstream (`<clone>/CONTRIBUTING.md`).
