...
`Notion-Version: <DATE>` is required on all HTTP requests. `ntn` handles this for you. In this version, what users call "databases" are called **data sources** in the API.
...
## API Version <DATE> — Databases vs Data Sources
...
**Inline:**
- Mentions: `<mention-user url="..."/>`, `<mention-page url="...">Title</mention-page>`, `<mention-date start="<DATE>"/>`
